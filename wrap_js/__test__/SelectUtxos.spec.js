...
const elementsTestCase = [
  ...
  (() => {
    ...
    return TestHelper.createElementsTestCase(
      ...
      {amount: ( 1.3 * COIN_BASE), coinNum: 4, feeAmount: 37280, utxoFeeAmount: 7280},
      emptyFunc,
      clearUtxos,
      convertFunc,
    );
  ...
  (() => {
    ...
    return TestHelper.createElementsTestCase(
      ...
      {amount: (12 * COIN_BASE), coinNum: 2, feeAmount: 33640, utxoFeeAmount: 3640},
      emptyFunc,
      clearUtxos,
      convertFunc,
    );
  ...
  (() => {
    ...
    return TestHelper.createElementsTestCase(
      ...
      {amount: (14 * COIN_BASE), coinNum: 3, feeAmount: 35460, utxoFeeAmount: 5460},
      emptyFunc,
      clearUtxos,
      convertFunc,
    );
