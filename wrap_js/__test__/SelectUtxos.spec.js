...
const testCase = [
  ...
  (() => {
    ...
    return TestHelper.createBitcoinTestCase(
      ...
      {amount: ( 1.3 * COIN_BASE), coinNum: 4, feeAmount: 10360, utxoFeeAmount: 7360},
      emptyFunc,
      clearUtxos,
      convertFunc,
    );
...
const elementsTestCase = [
  ...
  (() => {
    ...
    return TestHelper.createElementsTestCase(
      ...
      {amount: ( 1.3 * COIN_BASE), coinNum: 4, feeAmount: 37360, utxoFeeAmount: 7360},
      emptyFunc,
      clearUtxos,
      convertFunc,
    );
  ...
  (() => {
    ...
    return TestHelper.createElementsTestCase(
      ...
      {amount: (12 * COIN_BASE), coinNum: 2, feeAmount: 33680, utxoFeeAmount: 3680},
      emptyFunc,
      clearUtxos,
      convertFunc,
    );
  ...
  (() => {
    ...
    return TestHelper.createElementsTestCase(
      ...
      {amount: (14 * COIN_BASE), coinNum: 3, feeAmount: 35520, utxoFeeAmount: 5520},
      emptyFunc,
      clearUtxos,
      convertFunc,
    );
