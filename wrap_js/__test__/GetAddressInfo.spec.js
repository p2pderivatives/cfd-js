...
const testCase = [
  TestHelper.createBitcoinTestCase(
    ...
    '{"lockingScript":"76a914f54a5851e9372b87810a8e60cdd2e7cfd80b6e3188ac","network":"mainnet","hashType":"p2pkh","witnessVersion":-1,"hash":"f54a5851e9372b87810a8e60cdd2e7cfd80b6e31"}',
  ),
  TestHelper.createBitcoinTestCase(
    'GetAddressInfo HashType(P2PKH) testnet',
    GetAddressInfo,
    ['{"isElements":false,"address":"mjawtDFWiNppWUqczgQevgyg6Hg7J8Uxcg"}'],
    '{"lockingScript":"76a9142ca1d2e7214b16725cf6310867460633a061edcb88ac","network":"testnet","hashType":"p2pkh","witnessVersion":-1,"hash":"2ca1d2e7214b16725cf6310867460633a061edcb"}',
  ),
  TestHelper.createBitcoinTestCase(
    'GetAddressInfo HashType(P2SH) mainnet',
    GetAddressInfo,
    ['{"isElements":false,"address":"3KxE77EHe1ip6WGRifwr9fZ5WBDGsLyWFz"}'],
    '{"lockingScript":"a914c852ac34a1c76b63a279c97502c9ccc4e3cb9e8b87","network":"mainnet","hashType":"p2sh","witnessVersion":-1,"hash":"c852ac34a1c76b63a279c97502c9ccc4e3cb9e8b"}',
  ),
  TestHelper.createBitcoinTestCase(
    'GetAddressInfo HashType(P2SH) testnet',
    GetAddressInfo,
    ['{"isElements":false,"address":"2NEbifo1SsiCYMQhGxGCg3tcTzR8xHuhqeH"}'],
    '{"lockingScript":"a914ea3ae70e53e6e2813002738cba26bd0cfcdecb0687","network":"testnet","hashType":"p2sh","witnessVersion":-1,"hash":"ea3ae70e53e6e2813002738cba26bd0cfcdecb06"}',
  ),
  TestHelper.createBitcoinTestCase(
    'GetAddressInfo HashType(P2SH-P2WPKH) mainnet',
    GetAddressInfo,
    ['{"isElements":false,"address":"3JvL6Ymt8MVWiCNHC7oWU6nLeHNJKLZGLN"}'],
    '{"lockingScript":"a914bcfeb728b584253d5f3f70bcb780e9ef218a68f487","network":"mainnet","hashType":"p2sh","witnessVersion":-1,"hash":"bcfeb728b584253d5f3f70bcb780e9ef218a68f4"}',
  ),
  TestHelper.createBitcoinTestCase(
    'GetAddressInfo HashType(P2SH-P2WPKH) testnet',
    GetAddressInfo,
    ['{"isElements":false,"address":"2NAUYAHhujozruyzpsFRP63mbrdaU5wnEpN"}'],
    '{"lockingScript":"a914bcfeb728b584253d5f3f70bcb780e9ef218a68f487","network":"testnet","hashType":"p2sh","witnessVersion":-1,"hash":"bcfeb728b584253d5f3f70bcb780e9ef218a68f4"}',
  ),
  TestHelper.createBitcoinTestCase(
    'GetAddressInfo HashType(P2SH-P2WSH) mainnet',
    GetAddressInfo,
    ['{"isElements":false,"address":"3NVZWnhKt53ukKw4Qm217Zk57FE8VnKjH2"}'],
    '{"lockingScript":"a914e4300531190587e3880d4c3004f5355d88ff928d87","network":"mainnet","hashType":"p2sh","witnessVersion":-1,"hash":"e4300531190587e3880d4c3004f5355d88ff928d"}',
  ),
  TestHelper.createBitcoinTestCase(
    'GetAddressInfo HashType(P2SH-P2WSH) testnet',
    GetAddressInfo,
    ['{"isElements":false,"address":"2NE3maXdMVXZFx7Zc5tdsjWjLKbSJHTyaoU"}'],
    '{"lockingScript":"a914e4300531190587e3880d4c3004f5355d88ff928d87","network":"testnet","hashType":"p2sh","witnessVersion":-1,"hash":"e4300531190587e3880d4c3004f5355d88ff928d"}',
  ),
  TestHelper.createBitcoinTestCase(
  ...
  TestHelper.createElementsTestCase(
    ...
    '{"lockingScript":"76a914f42331c418ef4517ba644ad6e9fc99681ad4393788ac","network":"liquidv1","hashType":"p2pkh","witnessVersion":-1,"hash":"f42331c418ef4517ba644ad6e9fc99681ad43937"}',
  ),
  TestHelper.createElementsTestCase(
    'GetAddressInfo Elements HashType(P2PKH) regtest',
    GetAddressInfo,
    ['{"isElements":true,"address":"2duUQnx5zuEhwsXtwpcYoA1xBGTzw7qDn18"}'],
    '{"lockingScript":"76a914dbe367d802d56c6c794b70a322f87c2fc766b32288ac","network":"regtest","hashType":"p2pkh","witnessVersion":-1,"hash":"dbe367d802d56c6c794b70a322f87c2fc766b322"}',
  ),
  TestHelper.createElementsTestCase(
    'GetAddressInfo Elements HashType(P2SH) liquidv1',
    GetAddressInfo,
    ['{"isElements":true,"address":"Gr23S1t38iLfYhoA3JVB41XgnHrGeuu4gW"}'],
    '{"lockingScript":"a91460ee0a71aed74b76902a335cc5575daeab769fa987","network":"liquidv1","hashType":"p2sh","witnessVersion":-1,"hash":"60ee0a71aed74b76902a335cc5575daeab769fa9"}',
  ),
  TestHelper.createElementsTestCase(
    'GetAddressInfo Elements HashType(P2SH) regtest',
    GetAddressInfo,
    ['{"isElements":true,"address":"XRpicZNrFZumBMhRV5BSYW28pGX7JyY1ua"}'],
    '{"lockingScript":"a9149ec42b6cfa1b0bc3f55f07af29867057cb0b8a2e87","network":"regtest","hashType":"p2sh","witnessVersion":-1,"hash":"9ec42b6cfa1b0bc3f55f07af29867057cb0b8a2e"}',
  ),
  TestHelper.createElementsTestCase(
    'GetAddressInfo Elements HashType(P2SH-P2WPKH) liquidv1',
    GetAddressInfo,
    ['{"isElements":true,"address":"Gpxfy5S6c6c9MCGHDSetdXpURmAck8LX84"}'],
    '{"lockingScript":"a9145552bfdf1d11e4b0ff877bf0012ae1cc054d398687","network":"liquidv1","hashType":"p2sh","witnessVersion":-1,"hash":"5552bfdf1d11e4b0ff877bf0012ae1cc054d3986"}',
  ),
  TestHelper.createElementsTestCase(
    'GetAddressInfo Elements HashType(P2SH-P2WPKH) regtest',
    GetAddressInfo,
    ['{"isElements":true,"address":"XR8iZq5ZZGe6ArQMtGo327GbF6QbJcdFR5"}'],
    '{"lockingScript":"a91497337debcc62f2ede4fd37263323c089801c932987","network":"regtest","hashType":"p2sh","witnessVersion":-1,"hash":"97337debcc62f2ede4fd37263323c089801c9329"}',
  ),
  TestHelper.createElementsTestCase(
    'GetAddressInfo Elements HashType(P2SH-P2WSH) liquidv1',
    GetAddressInfo,
    ['{"isElements":true,"address":"Gmavxxp6FY96977GGvBwk71VXFTFMdig4y"}'],
    '{"lockingScript":"a914304dbd9f6ef2f06cf16d8087343b30db00a18c1d87","network":"liquidv1","hashType":"p2sh","witnessVersion":-1,"hash":"304dbd9f6ef2f06cf16d8087343b30db00a18c1d"}',
  ),
  TestHelper.createElementsTestCase(
    'GetAddressInfo Elements HashType(P2SH-P2WSH) regtest',
    GetAddressInfo,
    ['{"isElements":true,"address":"XCxh9LWwzygfq9P1g6HjXmxfTRcqDejiGd"}'],
    '{"lockingScript":"a91411aca2b63fbee2cdda856217a8863135b070978b87","network":"regtest","hashType":"p2sh","witnessVersion":-1,"hash":"11aca2b63fbee2cdda856217a8863135b070978b"}',
  ),
  TestHelper.createElementsTestCase(
