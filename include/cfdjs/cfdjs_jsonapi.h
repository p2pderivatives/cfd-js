...
/**
 * @file cfdjs_jsonapi.h
 *
 * @brief cfd-apiで利用するJsonApiクラス定義
 *
 * JSON形式のAPIを提供する.
 */
#ifndef CFD_JS_INCLUDE_CFDJS_CFDJS_JSONAPI_H_
#define CFD_JS_INCLUDE_CFDJS_CFDJS_JSONAPI_H_
 ...
 * @brief 共通系の関数群クラス
 */
class CFD_JS_EXPORT JsonMappingApi {
 public:
  /**
...
#endif  // CFD_JS_INCLUDE_CFDJS_CFDJS_JSONAPI_H_
